            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex items-center justify-center mb-6">
                    ...
                    <div class="text-center flex-1 flex flex-col items-center">
                        ...
                        <div class="text-2xl font-bold text-copa-blue-500">{{ getTeamName(game.home_team) }}</div>
                    ...
                    <div class="text-center flex-1 flex flex-col items-center">
                        ...
                        <div class="text-2xl font-bold text-gray-700">{{ getTeamName(game.away_team) }}</div>
                        <div v-if="game.status === 'finished' || game.status === 'in_progress'"
                            class="text-5xl font-bold text-gray-800 mt-2">
                            {{ game.away_score }}
                        </div>
                ...
                <div class="space-y-6">
                    <div v-for="betType in availableBetTypes" :key="betType.id"
                        ...
                        <div v-else-if="betType.type === 'exact_score'" class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Gols {{ getTeamName(game.home_team) }}</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Gols {{ getTeamName(game.away_team) }}</label>
